...
driver.get('https://linemate.io/nfl/trends')
...
# Save data to CSV
with open(f'../nfl_saved_csv/nfl_betting_data_{current_date.strftime("%m_%d_%Y")}.csv', 'w', newline='', encoding='utf-8') as csvfile:
...
print('Data has been saved to ../nfl_saved_csv/nfl_betting_data.csv')
